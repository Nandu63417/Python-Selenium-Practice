...
queues = ['BOC Related Alerts','BOC CloseBatch Exceptions','MLT Related Alerts']
sub = "OMS US UC Alerts"

while(1):
    driver.get("https://oms-uc-1.lifetouch.net/smcfs/console/login.jsp?ErrorMsg=Unsupported_Login_Procedure")
